...
<html lang="en">
   ...
   <body>
      ...
      <div class="row">
	      ...
	      <div class="span9">
	         <div class="well">
	            <h1><i class="fa fa-bullhorn"></i> Announcer</h1>
	         </div>
	      </div>
			<div class="span9">
				<div class="well">
					...
					if(isset($_POST['users'])){
						...
						foreach($_POST['users'] as $one){
							$test = mail($one,$subject,$message,"From: ".$cuser['fname']." ".$cuser['lname']." (Announcement) <announcer@chs.ironk12.org>\nReply-To: ".$cuser['email']."");
							if(!$test){
								die("<div class=\"alert alert-danger\">Mail failed at ($one)</div>");
							}
						}
						$manage->activity("Sent announcement");
