	...
	<head>
  	...
  	<body>
		...
		if(isset($_POST["submit"])){
			...
			mysqli_stmt_prepare($res, "INSERT INTO `photoGroups` (`yearId`,`thumb`,`name`) VALUES (?, ?,?)");
			mysqli_stmt_bind_param($res, "iss", $yearId, $thumb, $name);
			...
			<div class="row">
				...
				<div class="span9 rel">
					<div class="well">
						...
						<?php if($cuser['edit'] == 1 || $editor == true){ ?><a href="editGroups.php?yearStart=<?=$year['yearstart']?>" class="btn btn-default pull-right absTR">Close</a><?php } ?>
					</div>
				</div>
				...
				<div class="span9">
					<div class="well">
						<form enctype="multipart/form-data" action="newGroup.php" method="POST">
							<input type="hidden" name="yearStart" value="<?php echo $yearStart?>">
							<input type="hidden" name="yearId" value="<?php echo $year["id"]?>">
							<input type="text" name="thumb" placeholder="Add Photo URL">
